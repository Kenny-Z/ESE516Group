...
static TaskHandle_t SensorReadTaskHandle    = NULL; //!< Sensor task handle
...
// 	if (xTaskhelohCreate(vWifiTask, "WIFI_TASK", WIFI_TASK_SIZE, NULL, WIFI_PRIORITY, &wifiTaskHandle) != pdPASS) {
// 		SerialConsoleWriteString("ERR: CLI task could not be initialized!\r\n");
// 	}
// 
